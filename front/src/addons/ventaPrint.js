...
export function printSale (sale) {
  ...
  element.innerHTML = `<div class="ticket"><img class="logo" src="${logoUrl}" alt="Mundolac"><h2>MUNDOLAC</h2><div class="center">COMPROBANTE DE VENTA</div><div class="line"></div>
